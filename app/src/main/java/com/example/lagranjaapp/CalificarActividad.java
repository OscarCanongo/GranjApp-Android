...
import com.example.lagranjaapp.Adapter.CalificarActividadAdapter;
...
public class CalificarActividad extends AppCompatActivity {

    private RecyclerView recyclerView;
    private CalificarActividadAdapter adapter;
    ...
    private void setUpView(){
        ...
        adapter = new CalificarActividadAdapter(actividades);
        recyclerView = findViewById(R.id.recyclerViewCalificarTarea);
